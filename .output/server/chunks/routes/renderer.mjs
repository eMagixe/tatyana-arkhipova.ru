...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/svg","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Татьяна Архипова - 3D Дизайнер"};
