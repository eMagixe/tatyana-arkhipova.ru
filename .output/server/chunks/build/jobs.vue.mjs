...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="bg-[url(&#39;/images/jobs.jpg&#39;)] pl-[100px] w-full h-[200px] bg-cover bg-center"></div><div class="w-full h-[80px] px-[100px] gradient-bg flex justify-start items-center"><h1 class="text-4xl text-white">Мой опыт работы</h1></div><div class="px-[100px] py-[50px] w-full flex gap-4">`);
