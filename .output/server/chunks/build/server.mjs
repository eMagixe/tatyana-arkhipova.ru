import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index.vue.mjs').then(function (n) { return n.i; })
  },
  {
    name: "skills",
    path: "/skills",
    component: () => import('./skills.vue.mjs')
  },
  {
    name: "contacts",
    path: "/contacts",
  ...
  },
  {
    name: "education",
    path: "/education",
    component: () => import('./education.vue.mjs')
  }
];
...
const dns_server_Ra8_F2GzcZ5EnW5bwpxFMZpu4rhlHsG_fCXvvBlwjzU = defineNuxtPlugin({
  parallel: true,
  async setup() {
  }
});
...
const strapi_sKhLINQNdwt_mhHLPJB0LMn9ASgy8vLNsKSmAAgEZsg = defineNuxtPlugin(async () => {
  let __temp, __restore;
  const user = useStrapiUser();
  if (!user.value) {
...
export { _export_sfc as _, useStrapiClient as a, _appConfig as b, useAppConfig as c, useNuxtApp as d, useRuntimeConfig as e, useRoute as f, useRouter as g, nuxtLinkDefaults as h, asyncDataDefaults as i, createError as j, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
