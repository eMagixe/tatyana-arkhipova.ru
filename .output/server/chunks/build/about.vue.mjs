...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      _push(`<!--[--><div class="bg-[url(&#39;/images/skills.jpg&#39;)] pl-[100px] w-full h-[200px] bg-cover bg-center"></div><div class="w-full h-[80px] px-[100px] gradient-bg flex justify-start items-center"><h1 class="text-4xl text-white">Обо мне</h1></div><div class="flex px-[100px] py-[50px] gap-8"><div class="w-[30%]"><img${ssrRenderAttr("src", `http://tatyana-arkhipova.ru:1337${(_a = unref(aboutData)) == null ? void 0 : _a.my_photo[0].url}`)} alt="my_photo"></div><div class="w-[70%] flex flex-col gap-4"><h2 class="text-2xl font-bold text-primary-500">Почему я занимаюсь моделерованием?</h2><!--[-->`);
